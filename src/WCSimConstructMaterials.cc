...
// -------------------------------------------------------------
  ...
  */
   ...
   G4double ENERGY_water_raman[NUMENTRIES_water_raman] =
     {7*eV, 6.5*eV, 6*eV, 5.5*eV ,4.96*eV ,4.13*eV, 3.54*eV, 3.10*eV, 2.76*eV, 2.48*eV, 2.25*eV, 2.07*eV, 1.77*eV, 1.55*eV,
       1.38*eV, 1.24*eV
...
//       };
  ...
  */
  ...
  // sep 09: for the large detector like superK the old values are muc better
   ...
   /*G4double RAMAN_water[NUMENTRIES_water] = {
      386929*cm*RAMFF,  366249*cm*RAMFF,  346398*cm*RAMFF,  327355*cm*RAMFF,  309097*cm*RAMFF,
      291603*cm*RAMFF,  274853*cm*RAMFF,  258825*cm*RAMFF,  243500*cm*RAMFF,  228856*cm*RAMFF,
      214873*cm*RAMFF,  201533*cm*RAMFF,  188816*cm*RAMFF,  176702*cm*RAMFF,  165173*cm*RAMFF,
      154210*cm*RAMFF,  143795*cm*RAMFF,  133910*cm*RAMFF,  124537*cm*RAMFF,  115659*cm*RAMFF,
      107258*cm*RAMFF, 99318.2*cm*RAMFF, 91822.2*cm*RAMFF,   84754*cm*RAMFF, 78097.3*cm*RAMFF,
     71836.5*cm*RAMFF,   65956*cm*RAMFF, 60440.6*cm*RAMFF, 55275.4*cm*RAMFF, 50445.6*cm*RAMFF,
       45937*cm*RAMFF, 41735.2*cm*RAMFF, 37826.6*cm*RAMFF, 34197.6*cm*RAMFF, 30834.9*cm*RAMFF,
     27725.4*cm*RAMFF, 24856.6*cm*RAMFF, 22215.9*cm*RAMFF, 19791.3*cm*RAMFF, 17570.9*cm*RAMFF,
       15543*cm*RAMFF, 13696.6*cm*RAMFF, 12020.5*cm*RAMFF, 10504.1*cm*RAMFF, 9137.15*cm*RAMFF,
     7909.45*cm*RAMFF,  6811.3*cm*RAMFF, 5833.25*cm*RAMFF,  4966.2*cm*RAMFF, 4201.36*cm*RAMFF,
     3530.28*cm*RAMFF, 2944.84*cm*RAMFF, 2437.28*cm*RAMFF, 2000.18*cm*RAMFF,  1626.5*cm*RAMFF,
     1309.55*cm*RAMFF, 1043.03*cm*RAMFF, 821.016*cm*RAMFF,  637.97*cm*RAMFF, 488.754*cm*RAMFF
     };*/

   G4double RAMAN_water[NUMENTRIES_water_raman] = {                                                                                                                         
						   17.1*m*RAMFF, 25.5*m*RAMFF, 38.9*m*RAMFF, 61.8*m*RAMFF, 106.9*m*RAMFF, 281.1*m*RAMFF, 636.2*m*RAMFF, 1291.1*m*RAMFF, 2410.3*m*RAMFF, 4213.0*m*RAMFF, 6981.8*m*RAMFF, 11072.5*m*RAMFF, 
...
//    myMPT1->AddConstProperty("MIEHG_FORWARD_RATIO",MIE_water_const[2]);
   ...
   myMPT2->AddProperty("RAMAN",ENERGY_water, RAYLEIGH_air, NUMENTRIES_water);
