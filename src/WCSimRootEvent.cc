					   ...
					   std::vector<ReflectionSurface_t> reflec)
{
  ...
  //std::cout<< "Rayleigh: " << nRayScat << std::endl;
  // std::cout<< "Raman_trigger: " << nRamScat << std::endl;
  //std::cout<< "Mie: " << nMieScat << std::endl;
...
WCSimRootCherenkovHitHistory::WCSimRootCherenkovHitHistory(Int_t nRayScat, Int_t nMieScat, std::vector<ReflectionSurface_t> refle)
{
  ...
  fNMieScat = nMieScat;
  fReflec = refle;
  //std::cout<< "Rayleigh: " << fNRayScat << std::endl;
  //std::cout<< "Raman: " << fNRamScat << std::endl;
  //std::cout<< "Mie: " << fNMieScat << std::endl;
}
