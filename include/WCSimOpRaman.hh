...
class G4OpRaman : public G4VDiscreteProcess 
{
...
public:
        ...
        G4OpRaman(const G4String& processName = "OpRaman",
                              G4ProcessType type = fOptical);
	~G4OpRaman();

private:

        G4OpRaman(const G4OpRaman &right);

        //////////////
        // Operators
        //////////////

        G4OpRaman& operator=(const G4OpRaman &right);
...
inline
G4bool G4OpRaman::IsApplicable(const G4ParticleDefinition& aParticleType)
{
  return ( &aParticleType == G4OpticalPhoton::OpticalPhoton() );
}

inline
void G4OpRaman::DumpPhysicsTable() const
...
inline G4PhysicsTable* G4OpRaman::GetPhysicsTable() const
{
